package com.example.zohar.androiddeepbok.widget.recyclerview;
 ...
 * @param <E>
 */
public abstract class BaseWithEmptyViewAdapter<E> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (EMPTY_VIEW != itemViewType) {
            onBindItemHolder(mDataList, holder, position, onItemClickListener);
        } else {
            onBindEmptyHolder(holder);
        }
    }

    public abstract void onBindItemHolder(List<E> mDataList, RecyclerView.ViewHolder holder, int position, OnItemClickListener onItemClickListener);
